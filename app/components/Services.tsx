...
const Services : FC<ServicesProps> = ({isDarkMode,setIsDarkMode}) => {
  return (
    <div id="services" className='w-full px-[12%] py-10 scroll-mt-20'>
        <h4 className='text-center mb-2 text-lg font-Ovo'>What I Offer</h4>
        <h2 className='text-center text-5xl font-Ovo'>My Services</h2>

        <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>I am a Full Stack Developer from Hyderabad, India with nearly 1 year of experience</p>

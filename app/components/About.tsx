...
const About: FC<AboutProps> = ({isDarkMode,setIsDarkMode}) => {
  return (
        ...
        <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'> 
          ...
          <div className='flex-1'>
                <p className='mb-10 max-w-2xl font-Ovo'>
                  I am an Full stack developer with an experience of 1 year of professional expertise in the field. Throughout my career, I have had the privilege of cooaborating with prestigious organizations, contributing to their success and growth
                </p>
